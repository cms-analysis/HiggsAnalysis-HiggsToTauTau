...
void mssm_xs_tools::help(){
  ...
  std::cout<<"-  Give_Xsec_bbX5f(Double_t mA, Double_t tanb) gives the xsection in pb "<<std::endl;
  ...
  std::cout<<"   for b-associated production in the 5 flavour scheme (X can be h, H or A)"<<std::endl;
  std::cout<<"-  Give_Xsec_ggFX(Double_t mA, Double_t tanb) gives the xsection in pb "<<std::endl;
  ...
  std::cout<<"          (Give_XsecUnc_pdf68up/pdf68down)"<<std::endl;
  ...
  std::cout<<"          (Give_XsecUnc_pdfalphas68up/pdfalphas68down)"<<std::endl;
  std::cout<<"          - Currently not available for b-assoc. prod. in 4 flavour scheme"<<std::endl;
  std::cout<<"$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$"<<std::endl;
...
void mssm_xs_tools::SetInput(char* filename){
  ...
  //BR (this could be extended easily)
...
Double_t mssm_xs_tools::Give_XsecUnc_muup_bbA5f(Double_t mA, Double_t tanb){ //up=scale0.5
  int gbin=m_h_bbH_muup_A->FindBin(mA,tanb);
  double highval=m_h_bbH_muup_A->GetBinContent(gbin);
  gbin=m_h_bbH_xsec_A->FindBin(mA,tanb);
  double central=m_h_bbH_xsec_A->GetBinContent(gbin);
  return (highval-central);
}
Double_t mssm_xs_tools::Give_XsecUnc_muup_bbh5f(Double_t mA, Double_t tanb){ //up=scale0.5
  int gbin=m_h_bbH_muup_h->FindBin(mA,tanb);
  double highval=m_h_bbH_muup_h->GetBinContent(gbin);
  gbin=m_h_bbH_xsec_h->FindBin(mA,tanb);
  double central=m_h_bbH_xsec_h->GetBinContent(gbin);
  return (highval-central);
}
Double_t mssm_xs_tools::Give_XsecUnc_muup_bbH5f(Double_t mA, Double_t tanb){ //up=scale0.5
  int gbin=m_h_bbH_muup_H->FindBin(mA,tanb);
...
Double_t mssm_xs_tools::Give_XsecUnc_mudown_bbA5f(Double_t mA, Double_t tanb){ //down=scale2.0
  int gbin=m_h_bbH_mudown_A->FindBin(mA,tanb);
  double lowval=m_h_bbH_mudown_A->GetBinContent(gbin);
  gbin=m_h_bbH_xsec_A->FindBin(mA,tanb);
  double central=m_h_bbH_xsec_A->GetBinContent(gbin);
  return (lowval-central); 
}
Double_t mssm_xs_tools::Give_XsecUnc_mudown_bbh5f(Double_t mA, Double_t tanb){ //down=scale2.0
  int gbin=m_h_bbH_mudown_h->FindBin(mA,tanb);
  double lowval=m_h_bbH_mudown_h->GetBinContent(gbin);
  gbin=m_h_bbH_xsec_h->FindBin(mA,tanb);
  double central=m_h_bbH_xsec_h->GetBinContent(gbin);
  return (lowval-central); 
}
...
Double_t mssm_xs_tools::Give_XsecUnc_pdf68down_bbA5f(Double_t mA, Double_t tanb){
  ...
  return (-1.)*m_h_bbH_pdf68down_A->GetBinContent(gbin);
}
Double_t mssm_xs_tools::Give_XsecUnc_pdf68down_bbh5f(Double_t mA, Double_t tanb){
  ...
  return (-1.)*m_h_bbH_pdf68down_h->GetBinContent(gbin);
}
Double_t mssm_xs_tools::Give_XsecUnc_pdf68down_bbH5f(Double_t mA, Double_t tanb){
  int gbin=m_h_bbH_pdf68down_H->FindBin(mA,tanb);
  return (-1.)*m_h_bbH_pdf68down_H->GetBinContent(gbin);
...
Double_t mssm_xs_tools::Give_XsecUnc_pdfalphas68up_bbA5f(Double_t mA, Double_t tanb){
  ...
  double alphasval=m_h_bbH_pdfalphas68up_A->GetBinContent(gbin);
  gbin=m_h_bbH_pdf68up_A->FindBin(mA,tanb);
  double pdfval=m_h_bbH_pdf68up_A->GetBinContent(gbin);
...
Double_t mssm_xs_tools::Give_XsecUnc_pdfalphas68up_bbh5f(Double_t mA, Double_t tanb){
  ...
  double alphasval=m_h_bbH_pdfalphas68up_h->GetBinContent(gbin);
  gbin=m_h_bbH_pdf68up_h->FindBin(mA,tanb);
  double pdfval=m_h_bbH_pdf68up_h->GetBinContent(gbin);
  return sqrt(alphasval*alphasval+pdfval*pdfval);
}
Double_t mssm_xs_tools::Give_XsecUnc_pdfalphas68up_bbH5f(Double_t mA, Double_t tanb){
  int gbin=m_h_bbH_pdfalphas68up_H->FindBin(mA,tanb);
...
Double_t mssm_xs_tools::Give_XsecUnc_pdfalphas68down_bbh5f(Double_t mA, Double_t tanb){
  ...
  double alphasval=m_h_bbH_pdfalphas68down_h->GetBinContent(gbin);
  gbin=m_h_bbH_pdf68down_h->FindBin(mA,tanb);
  double pdfval=m_h_bbH_pdf68down_h->GetBinContent(gbin);
  return -sqrt(alphasval*alphasval+pdfval*pdfval);
}
Double_t mssm_xs_tools::Give_XsecUnc_pdfalphas68down_bbH5f(Double_t mA, Double_t tanb){
  int gbin=m_h_bbH_pdfalphas68down_H->FindBin(mA,tanb);
...
Double_t mssm_xs_tools::Give_XsecUnc_muup_ggFA(Double_t mA, Double_t tanb){
  ...
  double highval=m_h_ggF_xsec05_A->GetBinContent(gbin);
  gbin=m_h_ggF_xsec_A->FindBin(mA,tanb);
  double centval=m_h_ggF_xsec_A->GetBinContent(gbin);
  return (highval-centval);
}

Double_t mssm_xs_tools::Give_XsecUnc_muup_ggFH(Double_t mA, Double_t tanb){
  int gbin=m_h_ggF_xsec05_H->FindBin(mA,tanb);
  double highval=m_h_ggF_xsec05_H->GetBinContent(gbin);
  gbin=m_h_ggF_xsec_H->FindBin(mA,tanb);
  double centval=m_h_ggF_xsec_H->GetBinContent(gbin);
  return (highval-centval);
}
...
Double_t mssm_xs_tools::Give_XsecUnc_mudown_ggFA(Double_t mA, Double_t tanb){
  ...
  double lowval=m_h_ggF_xsec20_A->GetBinContent(gbin);
  gbin=m_h_ggF_xsec_A->FindBin(mA,tanb);
  double centval=m_h_ggF_xsec_A->GetBinContent(gbin);
  return (lowval-centval);
}
...
Double_t mssm_xs_tools::Give_XsecUnc_mudown_ggFH(Double_t mA, Double_t tanb){
  ...
  double lowval=m_h_ggF_xsec20_H->GetBinContent(gbin);
  gbin=m_h_ggF_xsec_H->FindBin(mA,tanb);
  double centval=m_h_ggF_xsec_H->GetBinContent(gbin);
  return (lowval-centval);
}
...
Double_t mssm_xs_tools::Give_XsecUnc_pdfalphas68up_ggFA(Double_t mA, Double_t tanb){
  ...
  double alphasval=m_h_ggF_alphasup_A->GetBinContent(gbin);
  gbin=m_h_ggF_pdfup_A->FindBin(mA,tanb);
  double pdfval=m_h_ggF_pdfup_A->GetBinContent(gbin);
  return sqrt(alphasval*alphasval+pdfval*pdfval);
}
Double_t mssm_xs_tools::Give_XsecUnc_pdfalphas68up_ggFH(Double_t mA, Double_t tanb){
  ...
  double alphasval=m_h_ggF_alphasup_H->GetBinContent(gbin);
  gbin=m_h_ggF_pdfup_H->FindBin(mA,tanb);
  double pdfval=m_h_ggF_pdfup_H->GetBinContent(gbin);
  return sqrt(alphasval*alphasval+pdfval*pdfval);
}
Double_t mssm_xs_tools::Give_XsecUnc_pdfalphas68up_ggFh(Double_t mA, Double_t tanb){
  int gbin=m_h_ggF_alphasup_h->FindBin(mA,tanb);
...
Double_t mssm_xs_tools::Give_XsecUnc_pdfalphas68down_ggFA(Double_t mA, Double_t tanb){
  ...
  double alphasval=m_h_ggF_alphasdown_A->GetBinContent(gbin);
  gbin=m_h_ggF_pdfdown_A->FindBin(mA,tanb);
  double pdfval=m_h_ggF_pdfdown_A->GetBinContent(gbin);
  return -sqrt(alphasval*alphasval+pdfval*pdfval);
}
Double_t mssm_xs_tools::Give_XsecUnc_pdfalphas68down_ggFH(Double_t mA, Double_t tanb){
  ...
  double alphasval=m_h_ggF_alphasdown_H->GetBinContent(gbin);
  gbin=m_h_ggF_pdfdown_H->FindBin(mA,tanb);
  double pdfval=m_h_ggF_pdfdown_H->GetBinContent(gbin);
  return -sqrt(alphasval*alphasval+pdfval*pdfval);
}
Double_t mssm_xs_tools::Give_XsecUnc_pdfalphas68down_ggFh(Double_t mA, Double_t tanb){
  int gbin=m_h_ggF_alphasdown_h->FindBin(mA,tanb);
...
Double_t mssm_xs_tools::GiveXsec_UncUp_Santander_H(Double_t mA, Double_t tanb){
   double mh=this->Give_Mass_H(mA,tanb);
   double t=log(mh/4.75)-2.;
   // scale unc. for 4f:
   double dscale4f=this->Give_XsecUnc_muup_bbH4f(mA,tanb);
   double dscale5f=this->Give_XsecUnc_muup_bbH5f(mA,tanb);
   double pdf5f=Give_XsecUnc_pdfalphas68up_bbH5f(mA,tanb);
...
Double_t mssm_xs_tools::GiveXsec_UncUp_Santander_A(Double_t mA, Double_t tanb){
  double mh=mA;
   double t=log(mh/4.75)-2.;
   // scale unc. for 4f:
   double dscale4f=this->Give_XsecUnc_muup_bbA4f(mA,tanb);
   double dscale5f=this->Give_XsecUnc_muup_bbA5f(mA,tanb);
   double pdf5f=Give_XsecUnc_pdfalphas68up_bbA5f(mA,tanb);
   dscale5f=dscale5f+pdf5f;
   //double err=1./(1+t)*sqrt(dscale4f*dscale4f+(t*t*dscale5f*dscale5f));
   double err=1./(1+t)*(dscale4f+(t*dscale5f));
   return err;
...
Double_t mssm_xs_tools::GiveXsec_UncDown_Santander_H(Double_t mA, Double_t tanb){
   double mh=this->Give_Mass_H(mA,tanb);
   double t=log(mh/4.75)-2.;
   // scale unc. for 4f:
   double dscale4f=this->Give_XsecUnc_mudown_bbH4f(mA,tanb);
   double dscale5f=this->Give_XsecUnc_mudown_bbH5f(mA,tanb);
   double pdf5f=Give_XsecUnc_pdfalphas68down_bbH5f(mA,tanb);
   dscale5f=dscale5f+pdf5f;
   //double err=-1./(1+t)*sqrt(dscale4f*dscale4f+(t*t*dscale5f*dscale5f));
   double err=+1./(1+t)*(dscale4f+(t*dscale5f));
   return err;
...
Double_t mssm_xs_tools::GiveXsec_UncDown_Santander_A(Double_t mA, Double_t tanb){
  double mh=mA;
   double t=log(mh/4.75)-2.;
   // scale unc. for 4f:
   double dscale4f=this->Give_XsecUnc_mudown_bbA4f(mA,tanb);
   double dscale5f=this->Give_XsecUnc_mudown_bbA5f(mA,tanb);
   double pdf5f=Give_XsecUnc_pdfalphas68down_bbA5f(mA,tanb);
   dscale5f=dscale5f+pdf5f;
   //double err=-1./(1+t)*sqrt(dscale4f*dscale4f+(t*t*dscale5f*dscale5f));
   double err=+1./(1+t)*(dscale4f+(t*dscale5f));
   return err;
