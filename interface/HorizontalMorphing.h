...
/**
   \class   HorizontalMorphing HorizontalMorphing.h "HiggsAnalysis/HiggsToTauTau/interface/HorizontalMorphing.h"

   \brief   Class to facilitate horizontal template morphing
   ...
   horizontalMorphing = cms.PSet(
    ...
    ## lower bound mass value
    lowerBound = cms.double(100),
    ## lower bound acceptance
    lowerAccept= cms.double(0.2),    
    ## vector of mass points, which are subject to the morphing (bins)
    points = cms.VPSet(
