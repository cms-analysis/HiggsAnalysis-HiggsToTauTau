...
class PlotLimits {
 ...
 public:
  ...
  TGraphAsymmErrors* higgsConstraint(TH2D* plane_expected, double mass=125., double deltaM=1., const char* model="mhmax-mu+200", const char* type="h",bool first=false);
