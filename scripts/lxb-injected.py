...
parser.add_option("--MSSM", dest="MSSM", type="string", default="0",
                  help="Is this MSSM? 0=no, 1=yes. [Default: \"0\"]")
...
print "for MSSM? 1=yes, 0=no: {MSSM}"
    ...
    for idx in range(int(njob)):
        ...
        for mass_grp_idx, mass_group in enumerate(mass_groups):
            ...
            if options.condor :
                ...
                submit_script.write('qsub -l distro=sld5 -l site=hh -v scram_arch -v cmssw_base %s/%s\n'
