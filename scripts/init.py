...
parser.add_option("--tag", dest="version", default="V00-00-00", type="string", help="The cvs tag of the UserCode package to administrate the input files. [Default: \"V00-00-00\"]")
