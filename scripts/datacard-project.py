...
parser.add_option("-c", "--decay-channel", dest="channel", default="new", type="choice", help="Ditau decay channel. [Default: new]", choices=["new", "mm", "em", "et", "mt", "tt", "th", "hmm", "ee", "vhtt", "vhbb", "hbb", "AZh"])
...
if not options.channel == "new" :
    ...
    if options.channel == "hmm" or options.channel == "vhtt" or options.channel == "vhbb" or options.channel == "hbb" :
    ...
    os.system("cp -r %s/README %s" % (options.input, target_path))
