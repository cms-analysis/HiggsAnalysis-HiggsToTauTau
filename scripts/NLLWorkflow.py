...
os.system("cp plotted2Dhistos.pdf plottedXsBr.pdf massDifferences.pdf quantitiesDifference.pdf combinedXs.pdf deltaNLL.pdf NLLdiff.pdf CLsbComparison.pdf lightvsheavy.pdf PLOTS-model{model}-masspoint{masspoint}-tolerance{tolerance}{Max}-reference{reference}-contr{contr}".format(model=options.model, masspoint=options.modelMasspoint, tolerance=options.massTolerance, reference=options.referenceMass, contr=options.higgsContribution, Max="-MaxDenumerator" if options.toleranceDenumeratorMax else ""))
os.system("rm plotted2Dhistos.pdf plottedXsBr.pdf massDifferences.pdf quantitiesDifference.pdf combinedXs.pdf deltaNLL.pdf NLLdiff.pdf CLsbComparison.pdf lightvsheavy.pdf")