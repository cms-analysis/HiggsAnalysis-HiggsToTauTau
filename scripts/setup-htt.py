...
parser.add_option("-c", "--channels", dest="channels", default="ee mm em mt et tt", type="string", help="List of channels, for which datacards should be created. The list should be embraced by call-ons and separeted by whitespace or comma. Available channels are ee, mm, em, mt, et, tt, vhtt, hmm, hbb. [Default: \"ee mm em mt et tt\"]")
