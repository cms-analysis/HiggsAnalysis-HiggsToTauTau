...
directories_mssm = {
    ...
    '10' : ['nobtag'       , 'nobtag-et' , 'nobtag_low'   , 'nobtag_low-et'  ],
    '11' : ['nobtag'       , 'nobtag-et' , 'nobtag_medium', 'nobtag_medium-et'      ],
    '12' : ['nobtag'       , 'nobtag-et',  'nobtag_high'     , 'nobtag_high-et'         ],
    '13' : ['btag'         , 'btag-et' , 'btag_low'     , 'btag_low-et'          ],
    '14' : ['btag'          , 'btag-et'  ,   'btag_high'    , 'btag_high-et'      ],
    },
    'mt' : {
    '8'  : ['nobtag'       , 'nobtag-mt'       ],
    '9'  : ['btag'         , 'btag-mt'         ],
    ...
    '10' : ['nobtag'       , 'nobtag-mt'    , 'nobtag_low'   , 'nobtag_low-mt'   ],
    '11' : ['nobtag'       , 'nobtag-mt'  , 'nobtag_medium', 'nobtag_medium-mt'    ],
    '12' : ['nobtag'       , 'nobtag-mt'  , 'nobtag_high'  , 'nobtag_high-mt'     ],
    '13' : ['btag'         , 'btag-mt'   ,  'btag_low'     , 'btag_low-mt'     ],
    '14' : ['btag'          , 'btag-mt'   , 'btag_high'    , 'btag_high-mt'    ],
    },
    'tt' : {
    '8'  : ['nobtag'       , 'nobtag-tt'       ],
    '9'  : ['btag'         , 'btag-tt'         ],
    ...
    '10' : ['nobtag'       , 'nobtag-tt'    ,  'nobtag_low'   , 'nobtag_low-tt'   ],
    '11' : ['nobtag'       , 'nobtag-tt'   ,  'nobtag_medium', 'nobtag_medium-tt'  ],
    '12' : ['nobtag'       , 'nobtag-tt'   ,'nobtag_high'  , 'nobtag_high-tt'    ],
    '13' : ['btag'         , 'btag-tt'    , 'btag_low'     , 'btag_low-tt'     ],
    '14' : ['btag'          , 'btag-tt'   ,'btag_high'    , 'btag_high-tt'       ],   
    },
}
