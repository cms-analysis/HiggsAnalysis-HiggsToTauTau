...
directories_sm = {
    'em' : {
    '0' : ['0jet', 'dilepton', '1jet', 'vbf', 'htt', 'cmb'],
    '1' : ['0jet', 'dilepton', '1jet', 'vbf', 'htt', 'cmb'],
    ...
    'et' : {
    '0' : ['0jet', '1jet', 'vbf', 'htt', 'cmb'],
    '1' : ['0jet', '1jet', 'vbf', 'htt', 'cmb'],
    '2' : ['0jet', '1jet', 'vbf', 'htt', 'cmb'],
    '3' : ['1jet', 'htt', 'cmb'],
    '4' : ['1jet', 'htt', 'cmb'],
    '5' : ['1jet', 'htt', 'cmb'],
    '6' : ['vbf' , 'htt', 'cmb'],
    ...
    'mm' : {
    '0' : ['0jet', '1jet', 'vbf', 'dilepton', 'htt', 'cmb'],
    '1' : ['0jet', '1jet', 'vbf', 'dilepton', 'htt', 'cmb'],
    '2' : ['1jet', 'dilepton', 'htt', 'cmb'],
    '3' : ['1jet', 'dilepton', 'htt', 'cmb'],
    '4' : ['vbf' , 'dilepton', 'htt', 'cmb'],
    },
    ...
    'mt' : {
    '0' : ['0jet', '1jet', 'vbf', 'htt', 'cmb', 'mt_nosoft'],
    '1' : ['0jet', '1jet', 'vbf', 'htt', 'cmb', 'mt_nosoft'],
    '2' : ['0jet', '1jet', 'vbf', 'htt', 'cmb', 'mt_nosoft'],
    '3' : ['1jet', 'htt', 'cmb', 'mt_nosoft'],
    '4' : ['1jet', 'htt', 'cmb', 'mt_nosoft'],
    '5' : ['1jet', 'htt', 'cmb', 'mt_nosoft'],
    '6' : ['vbf' , 'htt', 'cmb', 'mt_nosoft'],
    '7' : ['vbf' , 'htt', 'cmb', 'mt_nosoft'],
    '10': ['0jet', '1jet', 'vbf', 'htt', 'cmb', 'mt_soft'],
    '11': ['0jet', '1jet', 'vbf', 'htt', 'cmb', 'mt_soft'],
    '12': ['0jet', '1jet', 'vbf', 'htt', 'cmb', 'mt_soft'],
