...
parser.add_option("-a", "--analysis", dest="analysis", default="AZh", type="choice", help="Type of analysis (AZh or mssm). Lower case is required. [Default: AZh]", choices=["AZh", "mssm"])
...
cats1.add_option("--AZh-categories-AZh", dest="AZh_AZh_categories", default="0 1 2 3", type="string", help="List of ee event categories. [Default: \"0 1 2 3\"]")
...
def directories(channel) :
    if options.analysis == "AZh" :
        category_names = directories_AZh
    else :
