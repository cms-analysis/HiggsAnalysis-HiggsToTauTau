...
parser.add_option("-i", "--in", dest="input", default="UserCode/HiggsAnalysis/HiggsToTauTau/datacards", type="string", help="Name of the input directory from where to pick up the datacards. [Default: UserCode/HiggsAnalysis/HiggsToTauTau/datacards]")
