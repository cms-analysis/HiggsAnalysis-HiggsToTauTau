...
if options.update_setup :
  ...
  ## apply horizontal template morphing for finer step sizes for limit calculation
    ...
    if "et" in config.channels:
        ...
        os.system("horizontal-morphing.py --categories='eleTau_1jet0tag,eleTau_1jet1tag,eleTau_2jet0tag,eleTau_2jet1tag,eleTau_2jet2tag' --samples='bbH{MASS}' --uncerts='CMS_scale_t_etau_8TeV' --masses='250,350' --step-size 10. -v {SETUP}/et/htt_et.inputs-Hhh-8TeV.root".format(SETUP=setup, MASS="{MASS}"))
    ##mt
    if "mt" in config.channels:
        ...
        os.system("horizontal-morphing.py --categories='muTau_1jet0tag,muTau_1jet1tag,muTau_2jet0tag,muTau_2jet1tag,muTau_2jet2tag' --samples='bbH{MASS}' --uncerts='CMS_scale_t_mutau_8TeV' --masses='250,350' --step-size 10. -v {SETUP}/mt/htt_mt.inputs-Hhh-8TeV.root".format(SETUP=setup, MASS="{MASS}"))
    ##tt
