...
parser.add_option("--fine-binning", dest="fine_bin", default=False, action="store_true",
                  help="Use the finer binned inputs to morph the masspoints. [Default: False]")
...
template_morphing = Morph(args[0],options.categories,options.samples,options.uncerts,options.masses,options.step_size,options.verbose,options.extrapolate,options.trivial,options.fine_bin)
