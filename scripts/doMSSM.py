                ...
                if options.channels.find("et") > -1:
                    ...
                    ## tail fit for QCD shape uncertainties
                     ...
                     os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-7TeV-0.root -c et -e 7TeV -b 'QCD_CMS_htt_QCDShape_etau_nobtag_7TeVUp_fine_binning'   -k '8' --range 200 --no-uncerts".format(
                         DIR=dir, ANA=ana))
                    # os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-7TeV-0.root -c et -e 7TeV -b 'QCD_CMS_htt_QCDShape_etau_btag_7TeVDown_fine_binning' -k '9' --range 100 --no-uncerts".format(
                    #     DIR=dir, ANA=ana))
                    # os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-7TeV-0.root -c et -e 7TeV -b 'QCD_CMS_htt_QCDShape_etau_btag_7TeVUp_fine_binning'   -k '9' --range 100 --no-uncerts".format(
                    #     DIR=dir, ANA=ana))
