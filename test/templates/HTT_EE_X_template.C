...
#else
  if(std::string(inputfile).find("7TeV")!=std::string::npos){dataset = "CMS Preliminary, 4.9 fb^{-1} at 7 TeV";}
  if(std::string(inputfile).find("8TeV")!=std::string::npos){dataset = "CMS Preliminary, 19.7 fb^{-1} at 8 TeV";}
#endif
