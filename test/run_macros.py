...
log = {
    ...
    ("em", "1") : "true", #    if options.analysis == "sm" else  "false",
    ...
    ("mt", "6") : "false",
    ("mt", "7") : "false",
    ("et", "0") : "true"    if options.analysis == "sm" else  "false",
    ("et", "1") : "true"    if options.analysis == "sm" else  "false", 
...
max = {
    ("em", "0") : "2000", #    if options.analysis == "sm" else "300",  
    ("em", "1") :  "500", #    if options.analysis == "sm" else  "40",  
    ...
    ("mt", "6") :   "20",
    ("mt", "7") :    "5",
    ("et", "0") :  "100"    if options.analysis == "sm" else  "40", 
    ("et", "1") :   "20"    if options.analysis == "sm" else  "10", 
...
min = {
    ...
    ("em", "1") : "0.1", #   if options.analysis == "sm" else   "0.", 
    ...
    ("mt", "6") : "0",
    ("mt", "7") : "0",
    ("et", "0") : "0.1"   if options.analysis == "sm" else  "0.",
    ("et", "1") : "0.1"   if options.analysis == "sm" else  "0.",
