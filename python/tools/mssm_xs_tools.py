...
#print "xsec(gg->H, Santander):            x                                    ", mssm.xsec ("bbSantander->H::scaleUp"  , mA, tanb)
#print "xsec(gg->H, Santander):                      x                          ", mssm.xsec ("bbSantander->H::scaleDown", mA, tanb)
#print "xsec(gg->H, Santander):                                 x               ", mssm.xsec ("bbSantander->H::pdfasUp"  , mA, tanb)
#print "xsec(gg->H, Santander):                                            x    ", mssm.xsec ("bbSantander->H::pdfasDown", mA, tanb)
