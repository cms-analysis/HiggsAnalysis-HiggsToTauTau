...
layout = cms.PSet(
    ...
    #dataset = cms.string("H#rightarrowhh#rightarrowbb#tau#tau                                                          19.7 fb^{-1} (8 TeV)"),
    #dataset = cms.string("A#rightarrowZh#rightarrowll#tau#tau                                                          19.7 fb^{-1} (8 TeV)"),
    dataset = cms.string("Combination                                                      19.7 fb^{-1} (8 TeV)"),
    ## x-axis title
