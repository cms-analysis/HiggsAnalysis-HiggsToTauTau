...
parser = OptionParser(usage="usage: %prog [options] datacard.txt",
...
input_file = open(input_name,'r')
output_file = open(input_name.replace(".txt", "_Higgs.txt"), 'w')
...
shapes ggH_SM * ../common/{ROOTFILE} $CHANNEL/$PROCESS125 $CHANNEL/$PROCESS125_$SYSTEMATIC \n
shapes qqH_SM * ../common/{ROOTFILE} $CHANNEL/$PROCESS125 $CHANNEL/$PROCESS125_$SYSTEMATIC \n
shapes VH_SM * ../common/{ROOTFILE} $CHANNEL/$PROCESS125 $CHANNEL/$PROCESS125_$SYSTEMATIC
