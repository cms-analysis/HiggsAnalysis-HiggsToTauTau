  ...
  histName_   (cfg.getParameter<std::string>("histName"))
{
  ...
  if ( cfg.exists("inputFile") ) {
    ...
    outputFileName_ = cfg.exists("outputFile") ? cfg.getParameter<std::string>("outputFile") : "";
  } else {
  ...
  else if ( outputFileName_ == "" && inputFileName_lowerBound_ == inputFileName_upperBound_ )
