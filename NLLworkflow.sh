...
python HiggsAnalysis/HiggsToTauTau/scripts/NLLWorkflow.py --nll-path="$CMSSW_BASE/src/LIMITS-150707-mssm-500-15-30fb/plain-asimov-mhmodp-NLL/mt/" --ggH-bbH-path="$CMSSW_BASE/src/LIMITS-150707-mssm-500-15-30fb/plain-MSSMvsSM-asimov-ggH-bbH/" --model-masspoint="500-15-30fb-SMHsig1" --analysis="plain-MSSMvsSM"
